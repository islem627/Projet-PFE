...
public class CommandeDTO {
    ...
    public CommandeDTO(CommandeEntity commandeEntity) {
        ...
        this.livreurId = commandeEntity.getLivreurId();
        this.gouvernoratCmd=commandeEntity.getGouvernoratCmd();
    ...
    public CommandeEntity toEntity(CommandeDTO commandeDTO) {
        ...
        commandeDTO.setGouvernoratCmd(commandeDTO.getGouvernoratCmd());
