...
public class UserDTO {
    ...
    public UserDTO(Long id, String username, String email, String password, String address, String phone, String photo, String firstname, String lastname, Boolean confirme, String role, String passwordResetToken, String gouvernorat) {
        this.id = id;
        this.username = username;
        this.email = email;
        this.password = password;
    ...
    { UserDTO userDTO=new UserDTO();//création d'une nouvelle instance
        ...
        userDTO .setGouvernorat(userEntity.getGouvernorat());
        return userDTO;
    ...
    public UserEntity toEntity (UserDTO userDTO){
        ...
        userEntity.setGouvernorat(userDTO.getGouvernorat());
        return  userEntity ;
    }
}
